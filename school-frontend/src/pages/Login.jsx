...
//       if (isLogin) {
//         navigate('/'); // Login ho gaya toh Dashboard par jao
//       } else {
//         // Signup ho gaya toh form saaf karo aur Login par shift ho jao
//         setIsLogin(true);
...
//     } finally {
//       setIsLoading(false); // Loader band
//     }
//   };
...
//           <button 
//             type="submit" 
//             disabled={isLoading} // Loader chale toh button disable
