...
// import { FiMenu, FiX, FiUsers, FiHome, FiLogIn, FiChevronLeft, FiChevronRight, FiLogOut } from 'react-icons/fi'; // ✅ FiLogOut add kiya
...
//       <div 
//         className={`fixed left-0 top-16 h-[calc(100vh-4rem)] z-40 bg-blue-900 text-white transition-all duration-300 flex flex-col w-64 -translate-x-full md:relative md:top-0 md:h-screen md:translate-x-0 ${
//           isOpen ? "translate-x-0" : ""
//         } ${isCollapsed ? "md:w-20" : "md:w-64"}`}
//       >
//         <button 
//           onClick={() => setIsCollapsed(!isCollapsed)} 
//           className="hidden md:flex absolute -right-3 top-8 bg-blue-700 hover:bg-blue-600 text-white rounded-full w-6 h-6 items-center justify-center shadow-md z-50"
//         >
//           {isCollapsed ? <FiChevronRight size={16} /> : <FiChevronLeft size={16} />}
//         </button>

//         <div className={`p-6 border-b border-blue-800 transition-all ${isCollapsed ? "md:px-2 md:text-center" : ""}`}>
//           {!isCollapsed && <h1 className="text-2xl font-bold">School App</h1>}
//         </div>
...
//           <Link to="/about" onClick={() => setIsOpen(false)} className={`flex items-center gap-4 px-6 py-3 hover:bg-blue-800 transition-colors text-gray-200 hover:text-white border-l-4 border-transparent hover:border-white ${isCollapsed ? "md:justify-center md:px-0" : ""}`}>
//             <div className="w-6 text-center">📖</div>
//             {!isCollapsed && <span className="text-sm font-medium">About Us</span>}
//           </Link>

//           <Link to="/contact" onClick={() => setIsOpen(false)} className={`flex items-center gap-4 px-6 py-3 hover:bg-blue-800 transition-colors text-gray-200 hover:text-white border-l-4 border-transparent hover:border-white ${isCollapsed ? "md:justify-center md:px-0" : ""}`}>
//             <div className="w-6 text-center">📞</div>
//             {!isCollapsed && <span className="text-sm font-medium">Contact Us</span>}
//           </Link>
...
//   // ✅ 1. YEH STATE BATAEGA KON SIDEBAR DEKH SAKTA HAI
...
//             {/* ✅ 3. SIRF AUTHORIZED USER KO MOBILE MENU DIKHEGA */}
//             {authorizedUser && (
...
//           <div className="flex items-center gap-4">
//             {/* ✅ 4. TOP BAR CONDITION: AGAR LOGIN HA TOH NAAM AUR LOGOUT, WARNA ADMIN LOGIN */}
//             {authorizedUser ? (
...
//               </div>
//             ) : (
//               <Link to="/login" className="bg-blue-700 hover:bg-blue-600 px-4 py-1.5 rounded-md transition text-sm font-medium">
//                 Admin Login
//               </Link>
//             )}
//           </div>
...
//               {/* ✅ 6. setAuthorizedUser LOGIN KO PASS KIYA */}
